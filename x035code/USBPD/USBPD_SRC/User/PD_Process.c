...
//uint8_t SrcCap_9V3A_Tab[4] = {0X2C, 0Xd1, 0X01, 0X3E};

uint8_t SrcCap_12V3A_Tab[12] = {0X2C, 0Xc1, 0X03, 0X3E,0X2C, 0Xd1, 0X02, 0X3E, 0X2C, 0X91, 0X01, 0X3E};
    ...
    switch( PD_Ctl.PD_State )
    {
        ...
        case STA_TX_SRC_CAP:
            ...
            if( PD_Ctl.PD_Comm_Timer > 159 )
            {
                ...
                status = PD_Send_Handle(SrcCap_12V3A_Tab, 12 );
